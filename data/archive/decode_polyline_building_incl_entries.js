...
fs.readFile('./data/lageplan_matuzk_geoJSONFiles/buildings_polyline_incl_entries.geojson', 'utf8', (err, fileContents) => {
  if (err) {
    console.error(err)
    return
  }
  try {
    ...
    fs.writeFile("./data/lageplan_matuzk_geoJSONFiles/buildings_polygons_incl_entries.geojson",JSON.stringify(json), "utf-8", (err) => {
