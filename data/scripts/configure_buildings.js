...
//and copies the institution data into the buildings
...
fs.readFile('./data/lageplan_matuzk_geoJSONFiles/buildings_without_institutions_polygons.geojson', 'utf8', (err, fileContents) => {
  ...
  try {
    ...
    //first make the array "institutions" in every buildings object

    for (feature in json.features){
      json.features[feature].properties.institutions=[];
    }
