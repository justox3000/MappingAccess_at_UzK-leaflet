(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('simpl-schema'), require('lodash'), require('ttag'), require('js-quantities')) :
  typeof define === 'function' && define.amd ? define(['exports', 'simpl-schema', 'lodash', 'ttag', 'js-quantities'], factory) :
  (global = global || self, factory(global.index = {}, global.SimpleSchema, global.lodash, global.ttag, global.Qty));
}(this, function (exports, SimpleSchema, lodash, ttag, Qty) { 'use strict';
  ...
  function quantityDefinition(type) {
    ...
    if (accessibility) {
      lodash.extend(base.accessibility, accessibility);
    }
  ...
  var DoorSchema = new SimpleSchema({
    turningSpaceInFront: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject())
    }),
    doorOpensToOutside: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2())
      }
    },
    isAutomaticOrAlwaysOpen: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3())
      }
    },
    width: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject4()),
      description: ttag.t(_templateObject5())
    }),
    hasClearMarkingOnGlassDoor: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6())
      }
    },
    isEasyToHoldOpen: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject7())
      }
    },
    hasErgonomicDoorHandle: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject8())
      }
    },
    isRevolving: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject9())
      }
    },
    needsRadarKey: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject10())
      }
    },
    needsEuroKey: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject11())
      }
    }
  });
  ...
  var StairsSchema = createSchemaInstance('Stairs', {
    ...
    count: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$1())
      }
    },
    nosing: {
      type: Object,
    ...
    'nosing.isHighContrast': {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2$1())
      }
    },
    'nosing.isAntiSlip': {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3$1())
      }
    },
    name: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject4$1())
      }
    },
    stepHeight: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject5$1())
    }),
    hasHandRail: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6$1())
      }
    },
    hasTactileSafetyStrips: {
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject7$1())
      }
    },
    hasBrailleNavigation: {
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject8$1())
      }
    },
    alternativeMobileEquipmentIds: {
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject9$1())
      }
    },
    'alternativeMobileEquipmentIds.$': {
      type: String,
      label: ttag.t(_templateObject10$1())
    }
  });
  ...
  var EntranceSchema = new SimpleSchema({
    name: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$2()),
        example: ttag.t(_templateObject2$2())
      }
    },
    isMainEntrance: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3$2())
      }
    },
    isLevel: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject4$2())
      }
    },
    slopeAngle: {
      type: Number,
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject5$2()),
        question: ttag.t(_templateObject6$2())
      }
    },
    hasRemovableRamp: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject7$2())
      }
    },
    stairs: {
      type: StairsSchema,
      optional: true,
      label: ttag.t(_templateObject8$2()),
      accessibility: {
        question: ttag.t(_templateObject9$2())
      }
    },
    door: {
      type: DoorSchema,
      optional: true,
      label: ttag.t(_templateObject10$2()),
      accessibility: {
        questionBlockBegin: ttag.t(_templateObject11$1())
      }
    },
    elevatorEquipmentId: {
      type: String,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject12()),
    ...
    intercomEquipmentId: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject13()),
        machineData: true // TODO foreign object flow equipment
  ...
  var MirrorSchema = createSchemaInstance('Mirror', {
    isLocatedInsideRestroom: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$3())
      }
    },
    isAccessibleWhileSeated: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2$3())
      }
    },
  ...
  var WashBasinSchema = createSchemaInstance('WashBasin', {
    isLocatedInsideRestroom: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$4())
      }
    },
    height: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject2$4())
    }),
    spaceBelow: {
      type: Object,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3$3())
      }
    },
    spaceBelowHeight: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject4$3())
    }),
    spaceBelowDepth: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject5$3())
    })
  });
  ...
  var FoldingHandlesSchema = createSchemaInstance('FoldingHandles', {
    onUsersLeftSide: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$5())
      }
    },
    onUsersRightSide: {
      type: Boolean,
  ...
  var ToiletSchema = createSchemaInstance('Toilet', {
    heightOfBase: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject$6())
    }),
    spaceOnUsersLeftSide: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject2$6())
    }),
    spaceOnUsersRightSide: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject3$5())
    }),
    spaceInFront: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject4$5())
    }),
    hasFoldingHandles: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject5$4())
      }
    },
    foldingHandles: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6$3())
      }
    }
  });
  ...
  var ShowerSchema = createSchemaInstance('Shower', {
    ...
    isLevel: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$7())
      }
    },
    hasSupportRails: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2$7())
      }
    },
    supportRails: {
      type: Object,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3$6())
      }
    },
    supportRailsHeight: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject4$6())
    }),
    supportRailsAreAboveAndBelowControls: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject5$5())
      }
    },
    hasShowerSeat: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6$4())
      }
    },
    hasErgonomicHandle: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject7$3())
      }
    },
    showerSeatIsRemovable: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject8$3())
      }
    },
    showerSeatIsFolding: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject9$3())
      }
    }
  });
  ...
  var RestroomSchema = createSchemaInstance('Restroom', {
    signIcons: {
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject$8())
      }
    },
    'signIcons.$': {
      type: String,
    ...
    hasMirror: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2$8())
      }
    },
    mirror: {
      type: MirrorSchema,
    ...
    turningSpaceInside: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject3$7())
    }),
    hasSupportRails: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject4$7())
      }
    },
    toilet: {
      type: ToiletSchema,
      label: ttag.t(_templateObject5$6()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6$5())
      }
    },
    hasBathTub: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject7$4())
      }
    },
    entrance: {
      type: EntranceSchema,
      label: ttag.t(_templateObject8$4()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject9$4())
      }
    },
    hasShower: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject10$3())
      }
    },
    shower: {
      type: ShowerSchema,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject11$2())
      }
    },
    heightOfSoap: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject12$1())
    }),
    heightOfDrier: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject13$1())
    }),
    washBasin: {
      type: WashBasinSchema,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject14())
      }
    }
  }, RoomSchema);
  ...
  var StaffSchema = new SimpleSchema({
    canSeeVisitorsFromInside: {
      type: Boolean,
      label: ttag.t(_templateObject$9()),
      accessibility: {
        question: ttag.t(_templateObject2$9()),
        description: ttag.t(_templateObject3$8())
      },
      optional: true
    },
    isTrainedInSigning: {
      type: Boolean,
      label: ttag.t(_templateObject4$8()),
      accessibility: {
        question: ttag.t(_templateObject5$7())
      },
      optional: true
    },
    hasFreeAssistantForVisitors: {
      type: Boolean,
      label: ttag.t(_templateObject6$6()),
      accessibility: {
        question: ttag.t(_templateObject7$5())
      },
      optional: true
    },
    spokenLanguages: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject8$5())
      }
    },
    'spokenLanguages.$': {
      type: String,
      label: ttag.t(_templateObject9$5()),
  ...
  var WheelchairPlacesSchema = new SimpleSchema({
    count: {
      ...
      label: ttag.t(_templateObject$a()),
      accessibility: {
        question: ttag.t(_templateObject2$a())
      },
      min: 0
    },
    hasSpaceForAssistant: {
      type: Boolean,
      label: ttag.t(_templateObject3$9()),
      accessibility: {
        question: ttag.t(_templateObject4$9())
      },
      optional: true
    }
  });
  ...
  var MediaSchema = new SimpleSchema({
    type: {
      type: String,
      label: ttag.t(_templateObject$b()),
      allowedValues: ['document', 'menu', 'guide', 'presentation', 'exhibit', 'movie', 'play', 'screen'],
      accessibility: {
        question: ttag.t(_templateObject2$b()),
        options: [{
          value: 'document',
          label: ttag.t(_templateObject3$a())
        }, {
          value: 'menu',
          label: ttag.t(_templateObject4$a())
        }, {
          value: 'guide',
          label: ttag.t(_templateObject5$8())
        }, {
          value: 'presentation',
          label: ttag.t(_templateObject6$7())
        }, {
          value: 'exhibit',
          label: ttag.t(_templateObject7$6())
        }, {
          value: 'movie',
          label: ttag.t(_templateObject8$6())
        }, {
          value: 'screen',
          label: ttag.t(_templateObject9$6())
        }]
      }
    },
    name: {
      type: LocalizedStringSchema,
      label: ttag.t(_templateObject10$4()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject11$3()),
        description: ttag.t(_templateObject12$2())
      }
    },
    isBraille: {
      type: Boolean,
      label: ttag.t(_templateObject13$2()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject14$1())
      }
    },
    isAudio: {
      type: Boolean,
      label: ttag.t(_templateObject15()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject16())
      }
    },
    isLargePrint: {
      type: Boolean,
      label: ttag.t(_templateObject17()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject18())
      }
    },
    hasContrastingBackground: {
      type: Boolean,
      label: ttag.t(_templateObject19()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject20())
      }
    },
    hasDedicatedScreenForSubtitles: {
      type: Boolean,
      label: ttag.t(_templateObject21()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject22())
      }
    },
    hasSubtitles: {
      type: Boolean,
      label: ttag.t(_templateObject23()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject24())
      }
    },
    hasRealTimeCaptioning: {
      type: Boolean,
      label: ttag.t(_templateObject25()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject26())
      }
    },
    // There are no standardized language codes for this yet, so this needs to be an extra flag for now.
    hasPlainLanguageOption: {
      type: Boolean,
      label: ttag.t(_templateObject27()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject28())
      }
    },
    languages: {
      type: Array,
      label: ttag.t(_templateObject29()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject30())
      }
    },
    'languages.$': {
      type: String,
      label: ttag.t(_templateObject31()),
      allowedValues: ietfLanguageTagsAndSignLanguageCodes
    },
    turningSpaceInFront: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject32())
    })
  });
  ...
  var PaymentSchema = new SimpleSchema({
    hasPortablePaymentSystem: {
      type: Boolean,
      label: ttag.t(_templateObject$c()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2$c())
      }
    },
    acceptsPaymentByMobilePhone: {
      type: Boolean,
      label: ttag.t(_templateObject3$b()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject4$b())
      }
    },
    acceptsCreditCards: {
      type: Boolean,
      label: ttag.t(_templateObject5$9()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6$8())
      }
    },
    acceptsDebitCards: {
      type: Boolean,
      label: ttag.t(_templateObject7$7()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject8$7())
      }
    },
    acceptsCoins: {
      type: Boolean,
      label: ttag.t(_templateObject9$7()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject10$5())
      }
    },
    acceptsBills: {
      type: Boolean,
      label: ttag.t(_templateObject11$4()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject12$3())
      }
    },
    customPaymentMetaInfo: {
      type: Array,
      label: ttag.t(_templateObject13$3()),
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject14$2()),
        questionMore: ttag.t(_templateObject15$1()),
        description: ttag.t(_templateObject16$1())
      }
    },
    'customPaymentMetaInfo.$': {
      type: LocalizedStringSchema,
      label: ttag.t(_templateObject17$1()),
      accessibility: {
        question: ttag.t(_templateObject18$1())
      }
    }
  });
  ...
  var PathwaysSchema = new SimpleSchema({
    width: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject$e())
    }),
    widthAtObstacles: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject2$e())
    }),
    maxLongitudinalSlope: {
      type: Number,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3$d()),
        description: ttag.t(_templateObject4$d())
      }
    },
    maxLateralSlope: {
      type: Number,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject5$a()),
        description: ttag.t(_templateObject6$9())
      }
    }
  });
  ...
  var WheelchairParkingSchema = new SimpleSchema({
    location: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$f())
      }
    },
    distanceToEntrance: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject2$f())
    }),
    count: {
      type: Number,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3$e())
      },
      min: 0
    },
    isLocatedInside: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject4$e())
      }
    },
    width: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject5$b())
    }),
    length: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject6$a())
    }),
    maxVehicleHeight: quantityDefinition(LengthSchema, true, {
      question: ttag.t(_templateObject7$8())
    }),
    hasDedicatedSignage: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject8$8())
      }
    },
    paymentBySpace: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject9$8())
      }
    },
    paymentByZone: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject10$6())
      }
    },
    neededParkingPermits: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject11$5())
      }
    },
    'neededParkingPermits.$': {
      type: LocalizedStringSchema,
      accessibility: {
        question: ttag.t(_templateObject12$4())
      }
    }
  });
  var ParkingSchema = new SimpleSchema({
    forWheelchairUsers: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject13$4())
      }
    }
  });
  ...
  var GroundSchema = new SimpleSchema({
    sidewalkConditions: {
      ...
      max: 1,
      accessibility: {
        question: ttag.t(_templateObject$g()),
    ...
    isLevel: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2$g())
      }
    },
    slopeAngle: {
      type: Number,
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject3$f()),
        question: ttag.t(_templateObject4$f())
      }
    },
    evenPavement: {
      type: Boolean,
  ...
  var AnimalPolicySchema = new SimpleSchema({
    allowsGuideDogs: {
      type: Boolean,
      accessibility: {
        question: ttag.t(_templateObject$h())
      }
    },
    allowsServiceAnimals: {
      type: Boolean,
      accessibility: {
        question: ttag.t(_templateObject2$h())
      }
    },
    allowsDogs: {
      type: Boolean,
      accessibility: {
        question: ttag.t(_templateObject3$g())
      }
    },
    dogsNeedMuzzle: {
      type: Boolean,
      accessibility: {
        question: ttag.t(_templateObject4$g())
      }
    },
    allowsAnyPets: {
      type: Boolean,
      accessibility: {
        question: ttag.t(_templateObject5$d())
      }
    },
    suppliesWaterForPets: {
      type: Boolean,
      accessibility: {
        question: ttag.t(_templateObject6$c())
      }
    }
  });
  ...
  var smokingPolicies = [{
    label: ttag.t(_templateObject$i()),
    value: 'dedicatedToSmoking'
  }, {
    label: ttag.t(_templateObject2$i()),
    value: 'allowedEverywhere'
  }, {
    label: ttag.t(_templateObject3$h()),
    value: 'inSeparateArea'
  }, {
    label: ttag.t(_templateObject4$h()),
    value: 'inIsolatedArea'
  }, {
    label: ttag.t(_templateObject5$e()),
    value: 'prohibited'
  }, {
    label: ttag.t(_templateObject6$d()),
    value: 'onlyOutside'
  }];
  ...
  var AccessibilitySchema = new SimpleSchema({
    ...
    staff: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$j())
      }
    },
    wheelchairPlaces: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject2$j())
      }
    },
    media: {
      type: Array,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject3$i()),
        questionMore: ttag.t(_templateObject4$i()),
        description: ttag.t(_templateObject5$f())
      }
    },
    'media.$': {
      type: MediaSchema
    ...
    payment: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6$e())
      }
    },
    parking: {
      type: ParkingSchema,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject7$a())
      }
    },
    ground: {
      type: GroundSchema,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject8$9())
      }
    },
    ratingSpacious: {
      type: Number,
      ...
      accessibility: {
        deprecated: true,
        question: ttag.t(_templateObject9$9()),
        componentHint: 'StarRating'
      }
    },
    isWellLit: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject10$7())
      }
    },
    isQuiet: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject11$6())
      }
    },
    hasInductionLoop: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject12$5())
      }
    },
    ...
    smokingPolicy: {
      ...
      accessibility: {
        question: ttag.t(_templateObject13$5()),
    ...
    animalPolicy: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject14$3())
      }
    },
    pathways: {
      type: PathwaysSchema,
    ...
    entrances: {
      type: Array,
      optional: true,
      label: ttag.t(_templateObject15$2()),
      accessibility: {
        questionBlockBegin: ttag.t(_templateObject16$2()),
        questionMore: ttag.t(_templateObject17$2())
      }
    },
    ...
    restrooms: {
      type: Array,
      optional: true,
      label: ttag.t(_templateObject18$2()),
      accessibility: {
        questionBlockBegin: ttag.t(_templateObject19$1()),
        questionMore: ttag.t(_templateObject20$1())
      }
    },
    ...
    tables: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject21$1()),
        options: [{
          label: ttag.t(_templateObject22$1()),
    ...
    serviceContact: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject23$1())
      }
    },
    services: {
      type: Object,
  ...
  var isoAlphaThreeCountryCodes = [{
    value: 'ABW',
    label: ttag.t(_templateObject$k())
  }, {
    value: 'AFG',
    label: ttag.t(_templateObject2$k())
  }, {
    value: 'AGO',
    label: ttag.t(_templateObject3$j())
  }, {
    value: 'AIA',
    label: ttag.t(_templateObject4$j())
  }, {
    value: 'ALA',
    label: ttag.t(_templateObject5$g())
  }, {
    value: 'ALB',
    label: ttag.t(_templateObject6$f())
  }, {
    value: 'AND',
    label: ttag.t(_templateObject7$b())
  }, {
    value: 'ARE',
    label: ttag.t(_templateObject8$a())
  }, {
    value: 'ARG',
    label: ttag.t(_templateObject9$a())
  }, {
    value: 'ARM',
    label: ttag.t(_templateObject10$8())
  }, {
    value: 'ASM',
    label: ttag.t(_templateObject11$7())
  }, {
    value: 'ATA',
    label: ttag.t(_templateObject12$6())
  }, {
    value: 'ATF',
    label: ttag.t(_templateObject13$6())
  }, {
    value: 'ATG',
    label: ttag.t(_templateObject14$4())
  }, {
    value: 'AUS',
    label: ttag.t(_templateObject15$3())
  }, {
    value: 'AUT',
    label: ttag.t(_templateObject16$3())
  }, {
    value: 'AZE',
    label: ttag.t(_templateObject17$3())
  }, {
    value: 'BDI',
    label: ttag.t(_templateObject18$3())
  }, {
    value: 'BEL',
    label: ttag.t(_templateObject19$2())
  }, {
    value: 'BEN',
    label: ttag.t(_templateObject20$2())
  }, {
    value: 'BES',
    label: ttag.t(_templateObject21$2())
  }, {
    value: 'BFA',
    label: ttag.t(_templateObject22$2())
  }, {
    value: 'BGD',
    label: ttag.t(_templateObject23$2())
  }, {
    value: 'BGR',
    label: ttag.t(_templateObject24$1())
  }, {
    value: 'BHR',
    label: ttag.t(_templateObject25$1())
  }, {
    value: 'BHS',
    label: ttag.t(_templateObject26$1())
  }, {
    value: 'BIH',
    label: ttag.t(_templateObject27$1())
  }, {
    value: 'BLM',
    label: ttag.t(_templateObject28$1())
  }, {
    value: 'BLR',
    label: ttag.t(_templateObject29$1())
  }, {
    value: 'BLZ',
    label: ttag.t(_templateObject30$1())
  }, {
    value: 'BMU',
    label: ttag.t(_templateObject31$1())
  }, {
    value: 'BOL',
    label: ttag.t(_templateObject32$1())
  }, {
    value: 'BRA',
    label: ttag.t(_templateObject33())
  }, {
    value: 'BRB',
    label: ttag.t(_templateObject34())
  }, {
    value: 'BRN',
    label: ttag.t(_templateObject35())
  }, {
    value: 'BTN',
    label: ttag.t(_templateObject36())
  }, {
    value: 'BVT',
    label: ttag.t(_templateObject37())
  }, {
    value: 'BWA',
    label: ttag.t(_templateObject38())
  }, {
    value: 'CAF',
    label: ttag.t(_templateObject39())
  }, {
    value: 'CAN',
    label: ttag.t(_templateObject40())
  }, {
    value: 'CCK',
    label: ttag.t(_templateObject41())
  }, {
    value: 'CHE',
    label: ttag.t(_templateObject42())
  }, {
    value: 'CHL',
    label: ttag.t(_templateObject43())
  }, {
    value: 'CHN',
    label: ttag.t(_templateObject44())
  }, {
    value: 'CIV',
    label: ttag.t(_templateObject45())
  }, {
    value: 'CMR',
    label: ttag.t(_templateObject46())
  }, {
    value: 'COD',
    label: ttag.t(_templateObject47())
  }, {
    value: 'COG',
    label: ttag.t(_templateObject48())
  }, {
    value: 'COK',
    label: ttag.t(_templateObject49())
  }, {
    value: 'COL',
    label: ttag.t(_templateObject50())
  }, {
    value: 'COM',
    label: ttag.t(_templateObject51())
  }, {
    value: 'CPV',
    label: ttag.t(_templateObject52())
  }, {
    value: 'CRI',
    label: ttag.t(_templateObject53())
  }, {
    value: 'CUB',
    label: ttag.t(_templateObject54())
  }, {
    value: 'CUW',
    label: ttag.t(_templateObject55())
  }, {
    value: 'CXR',
    label: ttag.t(_templateObject56())
  }, {
    value: 'CYM',
    label: ttag.t(_templateObject57())
  }, {
    value: 'CYP',
    label: ttag.t(_templateObject58())
  }, {
    value: 'CZE',
    label: ttag.t(_templateObject59())
  }, {
    value: 'DEU',
    label: ttag.t(_templateObject60())
  }, {
    value: 'DJI',
    label: ttag.t(_templateObject61())
  }, {
    value: 'DMA',
    label: ttag.t(_templateObject62())
  }, {
    value: 'DNK',
    label: ttag.t(_templateObject63())
  }, {
    value: 'DOM',
    label: ttag.t(_templateObject64())
  }, {
    value: 'DZA',
    label: ttag.t(_templateObject65())
  }, {
    value: 'ECU',
    label: ttag.t(_templateObject66())
  }, {
    value: 'EGY',
    label: ttag.t(_templateObject67())
  }, {
    value: 'ERI',
    label: ttag.t(_templateObject68())
  }, {
    value: 'ESH',
    label: ttag.t(_templateObject69())
  }, {
    value: 'ESP',
    label: ttag.t(_templateObject70())
  }, {
    value: 'EST',
    label: ttag.t(_templateObject71())
  }, {
    value: 'ETH',
    label: ttag.t(_templateObject72())
  }, {
    value: 'FIN',
    label: ttag.t(_templateObject73())
  }, {
    value: 'FJI',
    label: ttag.t(_templateObject74())
  }, {
    value: 'FLK',
    label: ttag.t(_templateObject75())
  }, {
    value: 'FRA',
    label: ttag.t(_templateObject76())
  }, {
    value: 'FRO',
    label: ttag.t(_templateObject77())
  }, {
    value: 'FSM',
    label: ttag.t(_templateObject78())
  }, {
    value: 'GAB',
    label: ttag.t(_templateObject79())
  }, {
    value: 'GBR',
    label: ttag.t(_templateObject80())
  }, {
    value: 'GEO',
    label: ttag.t(_templateObject81())
  }, {
    value: 'GGY',
    label: ttag.t(_templateObject82())
  }, {
    value: 'GHA',
    label: ttag.t(_templateObject83())
  }, {
    value: 'GIB',
    label: ttag.t(_templateObject84())
  }, {
    value: 'GIN',
    label: ttag.t(_templateObject85())
  }, {
    value: 'GLP',
    label: ttag.t(_templateObject86())
  }, {
    value: 'GMB',
    label: ttag.t(_templateObject87())
  }, {
    value: 'GNB',
    label: ttag.t(_templateObject88())
  }, {
    value: 'GNQ',
    label: ttag.t(_templateObject89())
  }, {
    value: 'GRC',
    label: ttag.t(_templateObject90())
  }, {
    value: 'GRD',
    label: ttag.t(_templateObject91())
  }, {
    value: 'GRL',
    label: ttag.t(_templateObject92())
  }, {
    value: 'GTM',
    label: ttag.t(_templateObject93())
  }, {
    value: 'GUF',
    label: ttag.t(_templateObject94())
  }, {
    value: 'GUM',
    label: ttag.t(_templateObject95())
  }, {
    value: 'GUY',
    label: ttag.t(_templateObject96())
  }, {
    value: 'HKG',
    label: ttag.t(_templateObject97())
  }, {
    value: 'HMD',
    label: ttag.t(_templateObject98())
  }, {
    value: 'HND',
    label: ttag.t(_templateObject99())
  }, {
    value: 'HRV',
    label: ttag.t(_templateObject100())
  }, {
    value: 'HTI',
    label: ttag.t(_templateObject101())
  }, {
    value: 'HUN',
    label: ttag.t(_templateObject102())
  }, {
    value: 'IDN',
    label: ttag.t(_templateObject103())
  }, {
    value: 'IMN',
    label: ttag.t(_templateObject104())
  }, {
    value: 'IND',
    label: ttag.t(_templateObject105())
  }, {
    value: 'IOT',
    label: ttag.t(_templateObject106())
  }, {
    value: 'IRL',
    label: ttag.t(_templateObject107())
  }, {
    value: 'IRN',
    label: ttag.t(_templateObject108())
  }, {
    value: 'IRQ',
    label: ttag.t(_templateObject109())
  }, {
    value: 'ISL',
    label: ttag.t(_templateObject110())
  }, {
    value: 'ISR',
    label: ttag.t(_templateObject111())
  }, {
    value: 'ITA',
    label: ttag.t(_templateObject112())
  }, {
    value: 'JAM',
    label: ttag.t(_templateObject113())
  }, {
    value: 'JEY',
    label: ttag.t(_templateObject114())
  }, {
    value: 'JOR',
    label: ttag.t(_templateObject115())
  }, {
    value: 'JPN',
    label: ttag.t(_templateObject116())
  }, {
    value: 'KAZ',
    label: ttag.t(_templateObject117())
  }, {
    value: 'KEN',
    label: ttag.t(_templateObject118())
  }, {
    value: 'KGZ',
    label: ttag.t(_templateObject119())
  }, {
    value: 'KHM',
    label: ttag.t(_templateObject120())
  }, {
    value: 'KIR',
    label: ttag.t(_templateObject121())
  }, {
    value: 'KNA',
    label: ttag.t(_templateObject122())
  }, {
    value: 'KOR',
    label: ttag.t(_templateObject123())
  }, {
    value: 'KWT',
    label: ttag.t(_templateObject124())
  }, {
    value: 'LAO',
    label: ttag.t(_templateObject125())
  }, {
    value: 'LBN',
    label: ttag.t(_templateObject126())
  }, {
    value: 'LBR',
    label: ttag.t(_templateObject127())
  }, {
    value: 'LBY',
    label: ttag.t(_templateObject128())
  }, {
    value: 'LCA',
    label: ttag.t(_templateObject129())
  }, {
    value: 'LIE',
    label: ttag.t(_templateObject130())
  }, {
    value: 'LKA',
    label: ttag.t(_templateObject131())
  }, {
    value: 'LSO',
    label: ttag.t(_templateObject132())
  }, {
    value: 'LTU',
    label: ttag.t(_templateObject133())
  }, {
    value: 'LUX',
    label: ttag.t(_templateObject134())
  }, {
    value: 'LVA',
    label: ttag.t(_templateObject135())
  }, {
    value: 'MAC',
    label: ttag.t(_templateObject136())
  }, {
    value: 'MAF',
    label: ttag.t(_templateObject137())
  }, {
    value: 'MAR',
    label: ttag.t(_templateObject138())
  }, {
    value: 'MCO',
    label: ttag.t(_templateObject139())
  }, {
    value: 'MDA',
    label: ttag.t(_templateObject140())
  }, {
    value: 'MDG',
    label: ttag.t(_templateObject141())
  }, {
    value: 'MDV',
    label: ttag.t(_templateObject142())
  }, {
    value: 'MEX',
    label: ttag.t(_templateObject143())
  }, {
    value: 'MHL',
    label: ttag.t(_templateObject144())
  }, {
    value: 'MKD',
    label: ttag.t(_templateObject145())
  }, {
    value: 'MLI',
    label: ttag.t(_templateObject146())
  }, {
    value: 'MLT',
    label: ttag.t(_templateObject147())
  }, {
    value: 'MMR',
    label: ttag.t(_templateObject148())
  }, {
    value: 'MNE',
    label: ttag.t(_templateObject149())
  }, {
    value: 'MNG',
    label: ttag.t(_templateObject150())
  }, {
    value: 'MNP',
    label: ttag.t(_templateObject151())
  }, {
    value: 'MOZ',
    label: ttag.t(_templateObject152())
  }, {
    value: 'MRT',
    label: ttag.t(_templateObject153())
  }, {
    value: 'MSR',
    label: ttag.t(_templateObject154())
  }, {
    value: 'MTQ',
    label: ttag.t(_templateObject155())
  }, {
    value: 'MUS',
    label: ttag.t(_templateObject156())
  }, {
    value: 'MWI',
    label: ttag.t(_templateObject157())
  }, {
    value: 'MYS',
    label: ttag.t(_templateObject158())
  }, {
    value: 'MYT',
    label: ttag.t(_templateObject159())
  }, {
    value: 'NAM',
    label: ttag.t(_templateObject160())
  }, {
    value: 'NCL',
    label: ttag.t(_templateObject161())
  }, {
    value: 'NER',
    label: ttag.t(_templateObject162())
  }, {
    value: 'NFK',
    label: ttag.t(_templateObject163())
  }, {
    value: 'NGA',
    label: ttag.t(_templateObject164())
  }, {
    value: 'NIC',
    label: ttag.t(_templateObject165())
  }, {
    value: 'NIU',
    label: ttag.t(_templateObject166())
  }, {
    value: 'NLD',
    label: ttag.t(_templateObject167())
  }, {
    value: 'NOR',
    label: ttag.t(_templateObject168())
  }, {
    value: 'NPL',
    label: ttag.t(_templateObject169())
  }, {
    value: 'NRU',
    label: ttag.t(_templateObject170())
  }, {
    value: 'NZL',
    label: ttag.t(_templateObject171())
  }, {
    value: 'OMN',
    label: ttag.t(_templateObject172())
  }, {
    value: 'PAK',
    label: ttag.t(_templateObject173())
  }, {
    value: 'PAN',
    label: ttag.t(_templateObject174())
  }, {
    value: 'PCN',
    label: ttag.t(_templateObject175())
  }, {
    value: 'PER',
    label: ttag.t(_templateObject176())
  }, {
    value: 'PHL',
    label: ttag.t(_templateObject177())
  }, {
    value: 'PLW',
    label: ttag.t(_templateObject178())
  }, {
    value: 'PNG',
    label: ttag.t(_templateObject179())
  }, {
    value: 'POL',
    label: ttag.t(_templateObject180())
  }, {
    value: 'PRI',
    label: ttag.t(_templateObject181())
  }, {
    value: 'PRK',
    label: ttag.t(_templateObject182())
  }, {
    value: 'PRT',
    label: ttag.t(_templateObject183())
  }, {
    value: 'PRY',
    label: ttag.t(_templateObject184())
  }, {
    value: 'PSE',
    label: ttag.t(_templateObject185())
  }, {
    value: 'PYF',
    label: ttag.t(_templateObject186())
  }, {
    value: 'QAT',
    label: ttag.t(_templateObject187())
  }, {
    value: 'REU',
    label: ttag.t(_templateObject188())
  }, {
    value: 'ROU',
    label: ttag.t(_templateObject189())
  }, {
    value: 'RUS',
    label: ttag.t(_templateObject190())
  }, {
    value: 'RWA',
    label: ttag.t(_templateObject191())
  }, {
    value: 'SAU',
    label: ttag.t(_templateObject192())
  }, {
    value: 'SDN',
    label: ttag.t(_templateObject193())
  }, {
    value: 'SEN',
    label: ttag.t(_templateObject194())
  }, {
    value: 'SGP',
    label: ttag.t(_templateObject195())
  }, {
    value: 'SGS',
    label: ttag.t(_templateObject196())
  }, {
    value: 'SHN',
    label: ttag.t(_templateObject197())
  }, {
    value: 'SJM',
    label: ttag.t(_templateObject198())
  }, {
    value: 'SLB',
    label: ttag.t(_templateObject199())
  }, {
    value: 'SLE',
    label: ttag.t(_templateObject200())
  }, {
    value: 'SLV',
    label: ttag.t(_templateObject201())
  }, {
    value: 'SMR',
    label: ttag.t(_templateObject202())
  }, {
    value: 'SOM',
    label: ttag.t(_templateObject203())
  }, {
    value: 'SPM',
    label: ttag.t(_templateObject204())
  }, {
    value: 'SRB',
    label: ttag.t(_templateObject205())
  }, {
    value: 'SSD',
    label: ttag.t(_templateObject206())
  }, {
    value: 'STP',
    label: ttag.t(_templateObject207())
  }, {
    value: 'SUR',
    label: ttag.t(_templateObject208())
  }, {
    value: 'SVK',
    label: ttag.t(_templateObject209())
  }, {
    value: 'SVN',
    label: ttag.t(_templateObject210())
  }, {
    value: 'SWE',
    label: ttag.t(_templateObject211())
  }, {
    value: 'SWZ',
    label: ttag.t(_templateObject212())
  }, {
    value: 'SXM',
    label: ttag.t(_templateObject213())
  }, {
    value: 'SYC',
    label: ttag.t(_templateObject214())
  }, {
    value: 'SYR',
    label: ttag.t(_templateObject215())
  }, {
    value: 'TCA',
    label: ttag.t(_templateObject216())
  }, {
    value: 'TCD',
    label: ttag.t(_templateObject217())
  }, {
    value: 'TGO',
    label: ttag.t(_templateObject218())
  }, {
    value: 'THA',
    label: ttag.t(_templateObject219())
  }, {
    value: 'TJK',
    label: ttag.t(_templateObject220())
  }, {
    value: 'TKL',
    label: ttag.t(_templateObject221())
  }, {
    value: 'TKM',
    label: ttag.t(_templateObject222())
  }, {
    value: 'TLS',
    label: ttag.t(_templateObject223())
  }, {
    value: 'TON',
    label: ttag.t(_templateObject224())
  }, {
    value: 'TTO',
    label: ttag.t(_templateObject225())
  }, {
    value: 'TUN',
    label: ttag.t(_templateObject226())
  }, {
    value: 'TUR',
    label: ttag.t(_templateObject227())
  }, {
    value: 'TUV',
    label: ttag.t(_templateObject228())
  }, {
    value: 'TWN',
    label: ttag.t(_templateObject229())
  }, {
    value: 'TZA',
    label: ttag.t(_templateObject230())
  }, {
    value: 'UGA',
    label: ttag.t(_templateObject231())
  }, {
    value: 'UKR',
    label: ttag.t(_templateObject232())
  }, {
    value: 'UMI',
    label: ttag.t(_templateObject233())
  }, {
    value: 'URY',
    label: ttag.t(_templateObject234())
  }, {
    value: 'USA',
    label: ttag.t(_templateObject235())
  }, {
    value: 'UZB',
    label: ttag.t(_templateObject236())
  }, {
    value: 'VAT',
    label: ttag.t(_templateObject237())
  }, {
    value: 'VCT',
    label: ttag.t(_templateObject238())
  }, {
    value: 'VEN',
    label: ttag.t(_templateObject239())
  }, {
    value: 'VGB',
    label: ttag.t(_templateObject240())
  }, {
    value: 'VIR',
    label: ttag.t(_templateObject241())
  }, {
    value: 'VNM',
    label: ttag.t(_templateObject242())
  }, {
    value: 'VUT',
    label: ttag.t(_templateObject243())
  }, {
    value: 'WLF',
    label: ttag.t(_templateObject244())
  }, {
    value: 'WSM',
    label: ttag.t(_templateObject245())
  }, {
    value: 'YEM',
    label: ttag.t(_templateObject246())
  }, {
    value: 'ZAF',
    label: ttag.t(_templateObject247())
  }, {
    value: 'ZMB',
    label: ttag.t(_templateObject248())
  }, {
    value: 'ZWE',
    label: ttag.t(_templateObject249())
  }];
  ...
  var StructuredAddressSchema = new SimpleSchema({
    text: {
      label: ttag.t(_templateObject$l()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject2$l())
      },
      optional: true
    },
    room: {
      label: ttag.t(_templateObject3$k()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject4$k()),
        question: ttag.t(_templateObject5$h()),
        example: ttag.t(_templateObject6$g())
      },
      optional: true
    },
    level: {
      label: ttag.t(_templateObject7$c()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject8$b()),
        question: ttag.t(_templateObject9$b()),
        extendedInformationUrl: 'https://en.wikipedia.org/wiki/Storey',
        example: ttag.t(_templateObject10$9())
      },
      optional: true
    },
    building: {
      label: ttag.t(_templateObject11$8()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject12$7()),
        example: ttag.t(_templateObject13$7())
      },
      optional: true
    },
    house: {
      label: ttag.t(_templateObject14$5()),
      type: LocalizedStringSchema,
      accessibility: {
        question: ttag.t(_templateObject15$4())
      },
      optional: true
    },
    street: {
      label: ttag.t(_templateObject16$4()),
      type: LocalizedStringSchema,
      accessibility: {
        question: ttag.t(_templateObject17$4()),
        description: ttag.t(_templateObject18$4())
      },
      optional: true
    },
    postalCode: {
      label: ttag.t(_templateObject19$3()),
      type: LocalizedStringSchema,
      accessibility: {
        question: ttag.t(_templateObject20$3()),
        description: ttag.t(_templateObject21$3())
      },
      optional: true
    },
    areas: {
      label: ttag.t(_templateObject22$3()),
      type: Array,
      accessibility: {
        description: ttag.t(_templateObject23$3())
      },
      optional: true
    },
    'areas.$': {
    ...
    district: {
      label: ttag.t(_templateObject24$2()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject25$2()),
        question: ttag.t(_templateObject26$2())
      },
      optional: true
    },
    city: {
      label: ttag.t(_templateObject27$2()),
      type: LocalizedStringSchema,
      accessibility: {
        question: ttag.t(_templateObject28$2())
      },
      optional: true
    },
    regions: {
      label: ttag.t(_templateObject29$2()),
      type: Array,
      accessibility: {
        description: ttag.t(_templateObject30$2())
      },
      optional: true
    },
    'regions.$': {
    ...
    county: {
      label: ttag.t(_templateObject31$2()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject32$2())
      },
      optional: true
    },
    state: {
      label: ttag.t(_templateObject33$1()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject34$1())
      },
      optional: true
    },
    stateCode: {
      label: ttag.t(_templateObject35$1()),
      type: LocalizedStringSchema,
      accessibility: {
        description: ttag.t(_templateObject36$1())
      },
      optional: true
    },
    countryCode: {
      label: ttag.t(_templateObject37$1()),
      type: LocalizedStringSchema,
      optional: true,
      ...
      accessibility: {
        description: ttag.t(_templateObject38$1()),
  ...
  var EquipmentPropertiesSchema = new SimpleSchema({
    ...
    description: {
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject$m()),
        example: ttag.t(_templateObject2$m())
      }
    },
    ...
    longDescription: {
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject3$l())
      }
    },
    ...
    shortDescription: {
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject4$l())
      }
    },
    heightOfControls: {
      type: LengthSchema,
      ...
      accessibility: {
        componentHint: 'Unit',
        question: ttag.t(_templateObject5$i())
      }
    },
    door: {
      type: DoorSchema,
      optional: true,
      label: ttag.t(_templateObject6$h()),
      accessibility: {
        questionBlockBegin: ttag.t(_templateObject7$d())
      }
    },
    hasDoorsInBothDirections: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject8$c())
      }
    },
    cabinWidth: {
      type: LengthSchema,
      ...
      accessibility: {
        componentHint: 'Unit',
        question: ttag.t(_templateObject9$c())
      }
    },
    cabinLength: {
      type: LengthSchema,
      ...
      accessibility: {
        componentHint: 'Unit',
        question: ttag.t(_templateObject10$a())
      }
    },
    languages: {
      type: Array,
    ...
    'languages.$': {
      type: String,
      label: ttag.t(_templateObject11$9()),
      allowedValues: ietfLanguageTagsAndSignLanguageCodes
    },
    hasRaisedText: {
      type: Boolean,
    ...
    isIndoors: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject12$8())
      }
    },
    alternativeRouteInstructions: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject13$8())
      }
    },
    isWorking: {
      type: Boolean,
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject14$6()),
        accessibility: {
          machineData: true
        }
      }
    ...
    outOfOrderReason: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject15$5()),
    ...
    stateLastUpdate: {
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject16$5())
      }
    },
    plannedCompletionDate: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject17$5())
      }
    },
    manufacturerName: {
      type: LocalizedStringSchema,
    ...
    servicePhoneNumber: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject18$5()),
        description: ttag.t(_templateObject19$4()),
        example: ttag.t(_templateObject20$4()),
    ...
    serviceWebsiteUrl: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject21$4())
      }
    },
    sourceId: {
      type: String,
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject22$4())
      }
    },
    sourceImportId: {
      type: String,
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject23$4())
      }
    },
    placeSourceId: {
      type: String,
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject24$3())
      }
    },
    originalPlaceInfoId: {
      type: String,
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject25$3())
      }
    },
    disruptionSourceImportId: {
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject26$3())
      }
    },
    originalData: {
      type: String,
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject27$3())
      }
    },
    placeInfoId: {
      type: String,
      ...
      accessibility: {
        machineData: true,
        description: ttag.t(_templateObject28$3())
      }
    }
  });
  ...
  var PlacePropertiesSchema = new SimpleSchema({
    name: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject$n())
      }
    },
    category: {
      type: String,
      accessibility: {
        question: ttag.t(_templateObject2$n()),
    ...
    address: {
      type: AddressSchema,
      optional: true,
      label: ttag.t(_templateObject3$m()),
      accessibility: {
        question: ttag.t(_templateObject4$m()),
    ...
    description: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject5$j()),
    ...
    phoneNumber: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject6$i()),
        description: ttag.t(_templateObject7$e()),
        example: ttag.t(_templateObject8$d()),
        componentHint: 'PhoneNumber'
      }
    },
    emailAddress: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject9$d()),
        description: ttag.t(_templateObject10$b()),
        example: ttag.t(_templateObject11$a())
      }
    },
    accessibility: {
      ...
      optional: true,
      accessibility: {
        question: ttag.t(_templateObject12$9()),
        description: ttag.t(_templateObject13$9())
      }
    },
    infoPageUrl: {
      type: LocalizedStringSchema,
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject14$7())
      }
    },
    editPageUrl: {
      type: LocalizedStringSchema,
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject15$6())
      }
    },
    placeWebsiteUrl: {
      type: LocalizedStringSchema,
      ...
      optional: true,
      accessibility: {
        description: ttag.t(_templateObject16$6())
      }
    },
    // machine data fields
    ids: {
  ...
  var PlaceInfoSchema = new SimpleSchema({
    ...
    properties: {
      ...
      label: ttag.t(_templateObject$o()),
      accessibility: {
        question: ttag.t(_templateObject2$o())
      }
    },
    geometry: {
      type: GeometrySchema,
      label: ttag.t(_templateObject3$n()),
      accessibility: {
        question: ttag.t(_templateObject4$n()),
        inseparable: true
      }
    }
  });
  ...
  function evaluateMatchRule(data, rule) {
    ...
    try {
      for (var _iterator3 = lodash.entries(rule)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var _step3$value = _slicedToArray(_step3.value, 2),
            path = _step3$value[0],
            matcher = _step3$value[1];

        var fieldData = lodash.get(data, path);
        ...
        if (matcher && isObjectMatch) {
          var matched = false;
          var foundOperators = lodash.intersection(allowedOperators, Object.keys(matcher || {}));
          ...
          if (foundOperators.length === 1) {
            ...
            // match whole object
            matched = lodash.isMatch(fieldData, matcher);
          ...
          var equals = lodash.isEqual(fieldData, matcher);
  ...
  var parseIsAnyOfWithDefault = function parseIsAnyOfWithDefault(data, field, list, existsValue, doesNotExistValue) {
    ...
    return lodash.includes(list, rawValue) ? existsValue : doesNotExistValue;
  };
  ...
  var transformKoboToA11y = function transformKoboToA11y(data) {
    ...
    try {
      for (var _iterator = lodash.entries(mapping)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var _step$value = _slicedToArray(_step.value, 2),
            key = _step$value[0],
            value = _step$value[1];

        if (typeof value !== 'undefined') {
          lodash.setWith(result, key, value, customizedSetter);
        }
      }
    } catch (err) {
      _didIteratorError = true;
    ...
    if (!userDefinedA11y || userDefinedA11y === 'undefined') {
      ...
      if (a11y === 'yes') {
        lodash.set(result, 'properties.accessibility.accessibleWith.wheelchair', true);
        lodash.unset(result, 'properties.accessibility.partiallyAccessibleWith.wheelchair');
      } else if (a11y === 'partial') {
        lodash.unset(result, 'properties.accessibility.accessibleWith.wheelchair');
        lodash.set(result, 'properties.accessibility.partiallyAccessibleWith.wheelchair', true);
      } else if (a11y === 'no') {
        lodash.set(result, 'properties.accessibility.accessibleWith.wheelchair', false);
        lodash.unset(result, 'properties.accessibility.partiallyAccessibleWith.wheelchair');
      }
    } else {
      // ensure that only one value is set to true
      if (lodash.get(result, 'properties.accessibility.accessibleWith.wheelchair') === true) {
        lodash.unset(result, 'properties.accessibility.partiallyAccessibleWith.wheelchair');
      } else if (lodash.get(result, 'properties.accessibility.partiallyAccessibleWith.wheelchair') === true) {
        lodash.unset(result, 'properties.accessibility.accessibleWith.wheelchair');
      }
    } // rate place a11y
    ...
    if (toiletA11y === 'yes') {
      lodash.setWith(result, 'properties.accessibility.restrooms.0.isAccessibleWithWheelchair', true, customizedSetter);
    } else if (toiletA11y === 'no') {
      lodash.setWith(result, 'properties.accessibility.restrooms.0.isAccessibleWithWheelchair', false, customizedSetter);
    }
  ...
  exports.AccessibilitySchemaExtensionSchema = AccessibilitySchemaExtensionSchema;
  exports.AccessibleTablesPrefab = AccessibleTablesPrefab;
  exports.AddressSchema = AddressSchema;
  exports.AllowedEquipmentTypes = AllowedEquipmentTypes;
  exports.AnimalPolicySchema = AnimalPolicySchema;
  exports.BaseQuantitySchema = BaseQuantitySchema;
  exports.DoorSchema = DoorSchema;
  exports.EntranceSchema = EntranceSchema;
  exports.EquipmentInfoSchema = EquipmentInfoSchema;
  exports.EquipmentPropertiesSchema = EquipmentPropertiesSchema;
  exports.ExternalIdSchema = ExternalIdSchema;
  exports.FoldingHandlesSchema = FoldingHandlesSchema;
  exports.FormatVersion = FormatVersion;
  exports.GeometrySchema = GeometrySchema;
  exports.GroundSchema = GroundSchema;
  exports.LengthQuantitySchema = LengthQuantitySchema;
  exports.LengthSchema = LengthSchema;
  exports.LengthUnitKind = LengthUnitKind;
  exports.LocalizedStringSchema = LocalizedStringSchema;
  exports.MediaSchema = MediaSchema;
  exports.MirrorSchema = MirrorSchema;
  exports.OtherUnitKind = OtherUnitKind;
  exports.ParkingSchema = ParkingSchema;
  exports.PathwaysSchema = PathwaysSchema;
  exports.PaymentSchema = PaymentSchema;
  exports.PersonalProfileSchema = PersonalProfileSchema;
  exports.PlaceInfoSchema = PlaceInfoSchema;
  exports.PlacePropertiesSchema = PlacePropertiesSchema;
  exports.PointGeometrySchema = PointGeometrySchema;
  exports.QuestionFunctionContext = QuestionFunctionContext;
  exports.RestroomSchema = RestroomSchema;
  exports.RoomSchema = RoomSchema;
  exports.ShowerSchema = ShowerSchema;
  exports.StaffSchema = StaffSchema;
  exports.StairsSchema = StairsSchema;
  exports.StructuredAddressSchema = StructuredAddressSchema;
  exports.TablesSchema = TablesSchema;
  exports.ToiletSchema = ToiletSchema;
  exports.VolumeQuantitySchema = VolumeQuantitySchema;
  exports.VolumeSchema = VolumeSchema;
  exports.WashBasinSchema = WashBasinSchema;
  exports.WheelchairParkingSchema = WheelchairParkingSchema;
  exports.WheelchairPlacesSchema = WheelchairPlacesSchema;
  exports.createSchemaInstance = createSchemaInstance;
  exports.determineUnitKind = determineUnitKind;
  exports.evaluateAccessibilitySchemaExtension = evaluateAccessibilitySchemaExtension;
  exports.evaluateQuestionValue = evaluateQuestionValue;
  exports.evaluateRule = evaluateRule;
  exports.evaluateToiletWheelmapA11y = evaluateToiletWheelmapA11y;
  exports.evaluateWheelmapA11y = evaluateWheelmapA11y;
  exports.flatStepHeight = flatStepHeight;
  exports.forEachKeyInSchemas = forEachKeyInSchemas;
  exports.fullWheelmapA11yRuleSet = fullWheelmapA11yRuleSet;
  exports.getFirstSchemaFromDefinition = getFirstSchemaFromDefinition;
  exports.ietfLanguageTags = ietfLanguageTags;
  exports.ietfLanguageTagsAndSignLanguageCodes = ietfLanguageTagsAndSignLanguageCodes;
  exports.isDefinitionTypeArray = isDefinitionTypeArray;
  exports.isDefinitionTypeSchema = isDefinitionTypeSchema;
  exports.isoAlphaThreeCountryCodes = isoAlphaThreeCountryCodes;
  exports.makeQuestionContext = makeQuestionContext;
  exports.partialWheelmapA11yRuleSet = partialWheelmapA11yRuleSet;
  exports.quantityDefinition = quantityDefinition;
  exports.signLanguageCodes = signLanguageCodes;
  exports.smokingPolicies = smokingPolicies;
  exports.transformKoboToA11y = transformKoboToA11y;
  exports.validateUnit = validateUnit;
  exports.wheelChairWashBasin = wheelChairWashBasin;
  exports.wheelmapToiletA11yRuleSet = wheelmapToiletA11yRuleSet;
