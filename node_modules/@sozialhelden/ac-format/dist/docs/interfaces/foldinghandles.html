...
<head>
	...
	<title>FoldingHandles | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="foldinghandles.html" class="tsd-kind-icon">Folding<wbr>Handles</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="foldinghandles.html#distancebetweenhandles" class="tsd-kind-icon">distance<wbr>Between<wbr>Handles</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="foldinghandles.html#onusersleftside" class="tsd-kind-icon">on<wbr>Users<wbr>Left<wbr>Side</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="foldinghandles.html#onusersrightside" class="tsd-kind-icon">on<wbr>Users<wbr>Right<wbr>Side</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="foldinghandles.html#topheightfromfloor" class="tsd-kind-icon">top<wbr>Height<wbr>From<wbr>Floor</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">FoldingHandles</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="foldinghandles.html#distancebetweenhandles" class="tsd-kind-icon">distance<wbr>Between<wbr>Handles</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="foldinghandles.html#onusersleftside" class="tsd-kind-icon">on<wbr>Users<wbr>Left<wbr>Side</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="foldinghandles.html#onusersrightside" class="tsd-kind-icon">on<wbr>Users<wbr>Right<wbr>Side</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="foldinghandles.html#topheightfromfloor" class="tsd-kind-icon">top<wbr>Height<wbr>From<wbr>Floor</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="distancebetweenhandles" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> distance<wbr>Between<wbr>Handles</h3>
				<div class="tsd-signature tsd-kind-icon">distance<wbr>Between<wbr>Handles<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/FoldingHandles.ts#L23">FoldingHandles.ts:23</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Indicates how far the handles are apart.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="onusersleftside" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> on<wbr>Users<wbr>Left<wbr>Side</h3>
				<div class="tsd-signature tsd-kind-icon">on<wbr>Users<wbr>Left<wbr>Side<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/FoldingHandles.ts#L10">FoldingHandles.ts:10</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if there is a folding handle on left side (from the perspective of somebody using the
						toilet), <code>false</code> if not, <code>undefined</code> if condition is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="onusersrightside" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> on<wbr>Users<wbr>Right<wbr>Side</h3>
				<div class="tsd-signature tsd-kind-icon">on<wbr>Users<wbr>Right<wbr>Side<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/FoldingHandles.ts#L15">FoldingHandles.ts:15</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if there is a folding handle on right side (from the perspective of somebody using the
						toilet), <code>false</code> if not, <code>undefined</code> if condition is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="topheightfromfloor" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> top<wbr>Height<wbr>From<wbr>Floor</h3>
				<div class="tsd-signature tsd-kind-icon">top<wbr>Height<wbr>From<wbr>Floor<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/FoldingHandles.ts#L19">FoldingHandles.ts:19</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Indicates how high the folding handles are (top edge, measured from the floor).</p>
					</div>
				</div>
			</section>
		</section>
