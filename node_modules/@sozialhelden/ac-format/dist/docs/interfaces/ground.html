...
<head>
	...
	<title>Ground | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="ground.html" class="tsd-kind-icon">Ground</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ground.html#distancetodroppedcurb" class="tsd-kind-icon">distance<wbr>ToDropped<wbr>Curb</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ground.html#evenpavement" class="tsd-kind-icon">even<wbr>Pavement</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ground.html#islevel" class="tsd-kind-icon">is<wbr>Level</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ground.html#sidewalkconditions" class="tsd-kind-icon">sidewalk<wbr>Conditions</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ground.html#slopeangle" class="tsd-kind-icon">slope<wbr>Angle</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ground.html#turningspace" class="tsd-kind-icon">turning<wbr>Space</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ground.html#distancetodroppedcurb" class="tsd-kind-icon">distance<wbr>ToDropped<wbr>Curb</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ground.html#evenpavement" class="tsd-kind-icon">even<wbr>Pavement</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ground.html#islevel" class="tsd-kind-icon">is<wbr>Level</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ground.html#sidewalkconditions" class="tsd-kind-icon">sidewalk<wbr>Conditions</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ground.html#slopeangle" class="tsd-kind-icon">slope<wbr>Angle</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ground.html#turningspace" class="tsd-kind-icon">turning<wbr>Space</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="distancetodroppedcurb" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> distance<wbr>ToDropped<wbr>Curb</h3>
				<div class="tsd-signature tsd-kind-icon">distance<wbr>ToDropped<wbr>Curb<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Ground.ts#L23">Ground.ts:23</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Specifies the distance between the main entrance and the next dropped curb if the place is
						reachable from a street.</p>
					</div>
					<p>If people with mobility impairments have to use a secondary entrance, the walking distance
					between this entrance and the main entrance has to be added to this value.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="evenpavement" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> even<wbr>Pavement</h3>
				<div class="tsd-signature tsd-kind-icon">even<wbr>Pavement<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Ground.ts#L34">Ground.ts:34</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the pavement is even and not plastered, <code>false</code> if not. <code>undefined</code> if this condition
						is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Ground.ts#L15">Ground.ts:15</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the ground is level, <code>false</code> if not, <code>undefined</code> if the condition is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="sidewalkconditions" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> sidewalk<wbr>Conditions</h3>
				<div class="tsd-signature tsd-kind-icon">sidewalk<wbr>Conditions<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Ground.ts#L11">Ground.ts:11</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Rating value (range <code>[0..1]</code>) with subjective sidewalk conditions.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Ground.ts#L28">Ground.ts:28</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Angle of the slope that this ground has, if applicable. <code>undefined</code> if the slope is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="turningspace" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> turning<wbr>Space</h3>
				<div class="tsd-signature tsd-kind-icon">turning<wbr>Space<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Ground.ts#L39">Ground.ts:39</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Turning space that this ground provides to people.</p>
					</div>
				</div>
			</section>
		</section>
