...
<head>
	...
	<title>Mirror | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="mirror.html" class="tsd-kind-icon">Mirror</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="mirror.html#heightfromground" class="tsd-kind-icon">height<wbr>From<wbr>Ground</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="mirror.html#isaccessiblewhileseated" class="tsd-kind-icon">is<wbr>Accessible<wbr>While<wbr>Seated</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="mirror.html#islocatedinsiderestroom" class="tsd-kind-icon">is<wbr>Located<wbr>Inside<wbr>Restroom</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="mirror.html#heightfromground" class="tsd-kind-icon">height<wbr>From<wbr>Ground</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="mirror.html#isaccessiblewhileseated" class="tsd-kind-icon">is<wbr>Accessible<wbr>While<wbr>Seated</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="mirror.html#islocatedinsiderestroom" class="tsd-kind-icon">is<wbr>Located<wbr>Inside<wbr>Restroom</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="heightfromground" class="tsd-anchor"></a>
				<h3>height<wbr>From<wbr>Ground</h3>
				<div class="tsd-signature tsd-kind-icon">height<wbr>From<wbr>Ground<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Mirror.ts#L19">Mirror.ts:19</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>How far is the mirror&#39;s bottom from the ground?</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="isaccessiblewhileseated" class="tsd-anchor"></a>
				<h3>is<wbr>Accessible<wbr>While<wbr>Seated</h3>
				<div class="tsd-signature tsd-kind-icon">is<wbr>Accessible<wbr>While<wbr>Seated<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Mirror.ts#L15">Mirror.ts:15</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the mirror is accessible while sitting in a wheelchair, <code>false</code> if not, <code>undefined</code>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Mirror.ts#L10">Mirror.ts:10</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the mirror is located inside the restroom, <code>false</code> if not, <code>undefined</code> if
