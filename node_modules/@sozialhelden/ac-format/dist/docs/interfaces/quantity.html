...
<head>
	...
	<title>Quantity | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="quantity.html" class="tsd-kind-icon">Quantity</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="quantity.html#accuracy" class="tsd-kind-icon">accuracy</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="quantity.html#operator" class="tsd-kind-icon">operator</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="quantity.html#rawvalue" class="tsd-kind-icon">raw<wbr>Value</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="quantity.html#unit" class="tsd-kind-icon">unit</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="quantity.html#value" class="tsd-kind-icon">value</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		...
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">Quantity</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="quantity.html#accuracy" class="tsd-kind-icon">accuracy</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="quantity.html#operator" class="tsd-kind-icon">operator</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="quantity.html#rawvalue" class="tsd-kind-icon">raw<wbr>Value</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="quantity.html#unit" class="tsd-kind-icon">unit</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="quantity.html#value" class="tsd-kind-icon">value</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> accuracy</h3>
				<div class="tsd-signature tsd-kind-icon">accuracy<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Units.ts#L60">Units.ts:60</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>± in given units, uniform error</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">operator<span class="tsd-signature-symbol">:</span> <a href="../globals.html#operator" class="tsd-signature-type">Operator</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Units.ts#L52">Units.ts:52</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>the operator, indicating the value is not an absolute value</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="rawvalue" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> raw<wbr>Value</h3>
				<div class="tsd-signature tsd-kind-icon">raw<wbr>Value<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Units.ts#L58">Units.ts:58</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>raw, imported value, eg. &#39;90 .. 120cm&#39; - only required when importing</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Units.ts#L56">Units.ts:56</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>one of the length units in js-quantities</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Units.ts#L54">Units.ts:54</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>the value in the specified unit</p>
					</div>
				</div>
			</section>
		</section>
