...
<head>
	...
	<title>WashBasin | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="washbasin.html" class="tsd-kind-icon">Wash<wbr>Basin</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="washbasin.html#accessiblewithwheelchair" class="tsd-kind-icon">accessible<wbr>With<wbr>Wheelchair</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="washbasin.html#height" class="tsd-kind-icon">height</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="washbasin.html#islocatedinsiderestroom" class="tsd-kind-icon">is<wbr>Located<wbr>Inside<wbr>Restroom</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="washbasin.html#spacebelowdepth" class="tsd-kind-icon">space<wbr>Below<wbr>Depth</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="washbasin.html#spacebelowheight" class="tsd-kind-icon">space<wbr>Below<wbr>Height</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">WashBasin</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="washbasin.html#accessiblewithwheelchair" class="tsd-kind-icon">accessible<wbr>With<wbr>Wheelchair</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="washbasin.html#height" class="tsd-kind-icon">height</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="washbasin.html#islocatedinsiderestroom" class="tsd-kind-icon">is<wbr>Located<wbr>Inside<wbr>Restroom</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="washbasin.html#spacebelowdepth" class="tsd-kind-icon">space<wbr>Below<wbr>Depth</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="washbasin.html#spacebelowheight" class="tsd-kind-icon">space<wbr>Below<wbr>Height</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="accessiblewithwheelchair" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> accessible<wbr>With<wbr>Wheelchair</h3>
				<div class="tsd-signature tsd-kind-icon">accessible<wbr>With<wbr>Wheelchair<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/WashBasin.ts#L16">WashBasin.ts:16</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the wash basin is accessible with wheelchairs, <code>false</code> if not, <code>undefined</code>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">height<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/WashBasin.ts#L21">WashBasin.ts:21</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Defines at which height is the wash basin&#39;s top</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="islocatedinsiderestroom" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> is<wbr>Located<wbr>Inside<wbr>Restroom</h3>
				<div class="tsd-signature tsd-kind-icon">is<wbr>Located<wbr>Inside<wbr>Restroom<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/WashBasin.ts#L10">WashBasin.ts:10</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the restroom&#39;s wash basin is inside the cabin, <code>false</code> if not, <code>undefined</code>
						if condition is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="spacebelowdepth" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> space<wbr>Below<wbr>Depth</h3>
				<div class="tsd-signature tsd-kind-icon">space<wbr>Below<wbr>Depth<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/WashBasin.ts#L31">WashBasin.ts:31</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>How deep is the space below the wash basin?</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="spacebelowheight" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> space<wbr>Below<wbr>Height</h3>
				<div class="tsd-signature tsd-kind-icon">space<wbr>Below<wbr>Height<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/WashBasin.ts#L26">WashBasin.ts:26</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>How high is the space below the wash basin?</p>
					</div>
				</div>
			</section>
		</section>
