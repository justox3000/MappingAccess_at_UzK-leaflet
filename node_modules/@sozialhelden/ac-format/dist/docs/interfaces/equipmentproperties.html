...
<head>
	...
	<title>EquipmentProperties | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="equipmentproperties.html" class="tsd-kind-icon">Equipment<wbr>Properties</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#alternativerouteinstructions" class="tsd-kind-icon">alternative<wbr>Route<wbr>Instructions</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#cabinlength" class="tsd-kind-icon">cabin<wbr>Length</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#cabinwidth" class="tsd-kind-icon">cabin<wbr>Width</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#category" class="tsd-kind-icon">category</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#description" class="tsd-kind-icon">description</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#disruptionsourceimportid" class="tsd-kind-icon">disruption<wbr>Source<wbr>Import<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#door" class="tsd-kind-icon">door</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#hasbrailletext" class="tsd-kind-icon">has<wbr>Braille<wbr>Text</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#hasdoorsinbothdirections" class="tsd-kind-icon">has<wbr>Doors<wbr>InBoth<wbr>Directions</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#hasheadphonejack" class="tsd-kind-icon">has<wbr>Head<wbr>Phone<wbr>Jack</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#haslargeprint" class="tsd-kind-icon">has<wbr>Large<wbr>Print</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#hasraisedtext" class="tsd-kind-icon">has<wbr>Raised<wbr>Text</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#hasspeech" class="tsd-kind-icon">has<wbr>Speech</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#heightofcontrols" class="tsd-kind-icon">height<wbr>OfControls</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#ids" class="tsd-kind-icon">ids</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#iseasytounderstand" class="tsd-kind-icon">is<wbr>Easy<wbr>ToUnderstand</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#ishighcontrast" class="tsd-kind-icon">is<wbr>High<wbr>Contrast</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#isindoors" class="tsd-kind-icon">is<wbr>Indoors</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#isvoiceactivated" class="tsd-kind-icon">is<wbr>Voice<wbr>Activated</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#isworking" class="tsd-kind-icon">is<wbr>Working</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#languages" class="tsd-kind-icon">languages</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#longdescription" class="tsd-kind-icon">long<wbr>Description</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#manufacturername" class="tsd-kind-icon">manufacturer<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#manufacturerserialnumber" class="tsd-kind-icon">manufacturer<wbr>Serial<wbr>Number</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#originaldata" class="tsd-kind-icon">original<wbr>Data</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#originalid" class="tsd-kind-icon">original<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#originalplaceinfoid" class="tsd-kind-icon">original<wbr>Place<wbr>Info<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#outoforderreason" class="tsd-kind-icon">out<wbr>OfOrder<wbr>Reason</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#placeinfoid" class="tsd-kind-icon">place<wbr>Info<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#placesourceid" class="tsd-kind-icon">place<wbr>Source<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#plannedcompletiondate" class="tsd-kind-icon">planned<wbr>Completion<wbr>Date</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#servicephonenumber" class="tsd-kind-icon">service<wbr>Phone<wbr>Number</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#servicewebsiteurl" class="tsd-kind-icon">service<wbr>Website<wbr>Url</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#shortdescription" class="tsd-kind-icon">short<wbr>Description</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#sourceid" class="tsd-kind-icon">source<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#sourceimportid" class="tsd-kind-icon">source<wbr>Import<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#stateexplanation" class="tsd-kind-icon">state<wbr>Explanation</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="equipmentproperties.html#statelastupdate" class="tsd-kind-icon">state<wbr>Last<wbr>Update</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">EquipmentProperties</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#alternativerouteinstructions" class="tsd-kind-icon">alternative<wbr>Route<wbr>Instructions</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#cabinlength" class="tsd-kind-icon">cabin<wbr>Length</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#cabinwidth" class="tsd-kind-icon">cabin<wbr>Width</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#category" class="tsd-kind-icon">category</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#description" class="tsd-kind-icon">description</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#disruptionsourceimportid" class="tsd-kind-icon">disruption<wbr>Source<wbr>Import<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#door" class="tsd-kind-icon">door</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#hasbrailletext" class="tsd-kind-icon">has<wbr>Braille<wbr>Text</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#hasdoorsinbothdirections" class="tsd-kind-icon">has<wbr>Doors<wbr>InBoth<wbr>Directions</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#hasheadphonejack" class="tsd-kind-icon">has<wbr>Head<wbr>Phone<wbr>Jack</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#haslargeprint" class="tsd-kind-icon">has<wbr>Large<wbr>Print</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#hasraisedtext" class="tsd-kind-icon">has<wbr>Raised<wbr>Text</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#hasspeech" class="tsd-kind-icon">has<wbr>Speech</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#heightofcontrols" class="tsd-kind-icon">height<wbr>OfControls</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#ids" class="tsd-kind-icon">ids</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#iseasytounderstand" class="tsd-kind-icon">is<wbr>Easy<wbr>ToUnderstand</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#ishighcontrast" class="tsd-kind-icon">is<wbr>High<wbr>Contrast</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#isindoors" class="tsd-kind-icon">is<wbr>Indoors</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#isvoiceactivated" class="tsd-kind-icon">is<wbr>Voice<wbr>Activated</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#isworking" class="tsd-kind-icon">is<wbr>Working</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#languages" class="tsd-kind-icon">languages</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#longdescription" class="tsd-kind-icon">long<wbr>Description</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#manufacturername" class="tsd-kind-icon">manufacturer<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#manufacturerserialnumber" class="tsd-kind-icon">manufacturer<wbr>Serial<wbr>Number</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#originaldata" class="tsd-kind-icon">original<wbr>Data</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#originalid" class="tsd-kind-icon">original<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#originalplaceinfoid" class="tsd-kind-icon">original<wbr>Place<wbr>Info<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#outoforderreason" class="tsd-kind-icon">out<wbr>OfOrder<wbr>Reason</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#placeinfoid" class="tsd-kind-icon">place<wbr>Info<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#placesourceid" class="tsd-kind-icon">place<wbr>Source<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#plannedcompletiondate" class="tsd-kind-icon">planned<wbr>Completion<wbr>Date</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#servicephonenumber" class="tsd-kind-icon">service<wbr>Phone<wbr>Number</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#servicewebsiteurl" class="tsd-kind-icon">service<wbr>Website<wbr>Url</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#shortdescription" class="tsd-kind-icon">short<wbr>Description</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#sourceid" class="tsd-kind-icon">source<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#sourceimportid" class="tsd-kind-icon">source<wbr>Import<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#stateexplanation" class="tsd-kind-icon">state<wbr>Explanation</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="equipmentproperties.html#statelastupdate" class="tsd-kind-icon">state<wbr>Last<wbr>Update</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="alternativerouteinstructions" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> alternative<wbr>Route<wbr>Instructions</h3>
				<div class="tsd-signature tsd-kind-icon">alternative<wbr>Route<wbr>Instructions<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L218">EquipmentProperties.ts:218</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Short alternative routing instructions for travelers when they cannot use this facility.</p>
					</div>
					...
					<dl class="tsd-comment-tags">
						<dt>example</dt>
						<dd><p>‘Take the elevator near the Main Street entrance.’</p>
						</dd>
					</dl>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="cabinlength" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> cabin<wbr>Length</h3>
				<div class="tsd-signature tsd-kind-icon">cabin<wbr>Length<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L101">EquipmentProperties.ts:101</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Length / depth of the cabin when facing the equipment’s entrance, or <code>undefined</code> if the equipment has no cabin. For a hoist, this refers to the hoist platform itself.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="cabinwidth" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> cabin<wbr>Width</h3>
				<div class="tsd-signature tsd-kind-icon">cabin<wbr>Width<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L96">EquipmentProperties.ts:96</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Width of the cabin when facing the equipment’s entrance, or <code>undefined</code> if the equipment has no cabin. For a hoist, this refers to the hoist platform itself.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">category<span class="tsd-signature-symbol">:</span> <a href="../globals.html#equipmenttypes" class="tsd-signature-type">EquipmentTypes</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L85">EquipmentProperties.ts:85</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Type of the equipment or facility.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">description<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L55">EquipmentProperties.ts:55</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Describes where the equipment is located. If only one description string is technically
					...
					<dl class="tsd-comment-tags">
						<dt>example</dt>
						<dd><p>‘Between ticket counter and Central Line platforms’, ‘From basement upwards towards Main Street exit’</p>
						</dd>
					</dl>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="disruptionsourceimportid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> disruption<wbr>Source<wbr>Import<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">disruption<wbr>Source<wbr>Import<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L265">EquipmentProperties.ts:265</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Data source ID of a secondary source used for realtime status info on accessibility.cloud</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="door" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> door</h3>
				<div class="tsd-signature tsd-kind-icon">door<span class="tsd-signature-symbol">:</span> <a href="door.html" class="tsd-signature-type">Door</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L106">EquipmentProperties.ts:106</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Object describing the door to the equipment, or <code>undefined</code> if there is no door.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="hasbrailletext" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> has<wbr>Braille<wbr>Text</h3>
				<div class="tsd-signature tsd-kind-icon">has<wbr>Braille<wbr>Text<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L131">EquipmentProperties.ts:131</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment’s controls or signs are printed in braille letters, <code>false</code> if not, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="hasdoorsinbothdirections" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> has<wbr>Doors<wbr>InBoth<wbr>Directions</h3>
				<div class="tsd-signature tsd-kind-icon">has<wbr>Doors<wbr>InBoth<wbr>Directions<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L111">EquipmentProperties.ts:111</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment has doors in two directions, so wheelchair, rollator, bike or pushchair users do not have to move backwards to exit.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="hasheadphonejack" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> has<wbr>Head<wbr>Phone<wbr>Jack</h3>
				<div class="tsd-signature tsd-kind-icon">has<wbr>Head<wbr>Phone<wbr>Jack<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L155">EquipmentProperties.ts:155</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment has a headphone jack for speech output (common for ATMs), <code>false</code> if not, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="haslargeprint" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> has<wbr>Large<wbr>Print</h3>
				<div class="tsd-signature tsd-kind-icon">has<wbr>Large<wbr>Print<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L146">EquipmentProperties.ts:146</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment’s controls or signs do not use small fonts, <code>false</code> if they do, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="hasraisedtext" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> has<wbr>Raised<wbr>Text</h3>
				<div class="tsd-signature tsd-kind-icon">has<wbr>Raised<wbr>Text<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L126">EquipmentProperties.ts:126</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment’s controls or signs have raised letters, <code>false</code> if not, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="hasspeech" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> has<wbr>Speech</h3>
				<div class="tsd-signature tsd-kind-icon">has<wbr>Speech<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L136">EquipmentProperties.ts:136</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment has speech output, <code>false</code> if not, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="heightofcontrols" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> height<wbr>OfControls</h3>
				<div class="tsd-signature tsd-kind-icon">height<wbr>OfControls<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L91">EquipmentProperties.ts:91</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Height of the lowest working controls that are needed to operate this equipment.
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> ids</h3>
				<div class="tsd-signature tsd-kind-icon">ids<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ArrayLike</span><span class="tsd-signature-symbol">&lt;</span><a href="externalid.html" class="tsd-signature-type">ExternalId</a><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L298">EquipmentProperties.ts:298</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>IDs of this equipment in external data sources, for example in GTFS, IMDF or other sources.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="iseasytounderstand" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> is<wbr>Easy<wbr>ToUnderstand</h3>
				<div class="tsd-signature tsd-kind-icon">is<wbr>Easy<wbr>ToUnderstand<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L160">EquipmentProperties.ts:160</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment is easy to operate, <code>false</code> if people might face difficulties trying to understand how the equipment works, or <code>undefined</code> if this is unknown or irrelevant.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="ishighcontrast" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> is<wbr>High<wbr>Contrast</h3>
				<div class="tsd-signature tsd-kind-icon">is<wbr>High<wbr>Contrast<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L141">EquipmentProperties.ts:141</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment’s controls or signs have high contrast, <code>false</code> if not, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="isindoors" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> is<wbr>Indoors</h3>
				<div class="tsd-signature tsd-kind-icon">is<wbr>Indoors<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L121">EquipmentProperties.ts:121</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment is indoors, <code>false</code> if it’s fully or partially outdoors, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="isvoiceactivated" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> is<wbr>Voice<wbr>Activated</h3>
				<div class="tsd-signature tsd-kind-icon">is<wbr>Voice<wbr>Activated<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L151">EquipmentProperties.ts:151</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the equipment needs to be activated by voice, <code>false</code> if not, or <code>undefined</code> if this is unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="isworking" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> is<wbr>Working</h3>
				<div class="tsd-signature tsd-kind-icon">is<wbr>Working<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L195">EquipmentProperties.ts:195</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Live status update.</p>
					</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">languages<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ArrayLike</span><span class="tsd-signature-symbol">&lt;</span><a href="../globals.html#ietflanguagetagorsignlanguagecode" class="tsd-signature-type">IetfLanguageTagOrSignLanguageCode</a><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L116">EquipmentProperties.ts:116</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Languages of the equipment’s visible controls and/or voice output.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="longdescription" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> long<wbr>Description</h3>
				<div class="tsd-signature tsd-kind-icon">long<wbr>Description<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L73">EquipmentProperties.ts:73</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Contains the same information as description, but in a longer form which can be read out by a
					...
					<p>If only one description field can be used for technical reasons, then the written-out form
						MUST be given preference, because a short form can be generated from the long form more easily
					than the other way around.</p>
					<p>This attribute SHOULD be used as `aria-label`-attribute in web content.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="manufacturername" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> manufacturer<wbr>Name</h3>
				<div class="tsd-signature tsd-kind-icon">manufacturer<wbr>Name<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L165">EquipmentProperties.ts:165</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Official name of the company that manufactured the equipment.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="manufacturerserialnumber" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> manufacturer<wbr>Serial<wbr>Number</h3>
				<div class="tsd-signature tsd-kind-icon">manufacturer<wbr>Serial<wbr>Number<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L172">EquipmentProperties.ts:172</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Manufacturer serial number of the equipment / facility.</p>
					</div>
					<p>Intentionally not localizable to allow matching with other data, e.g. from manufacturer&#39;s own APIs.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="originaldata" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> original<wbr>Data</h3>
				<div class="tsd-signature tsd-kind-icon">original<wbr>Data<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L287">EquipmentProperties.ts:287</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Original source data for this equipment (for easier debugging)</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="originalid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> original<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">original<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L293">EquipmentProperties.ts:293</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>ID of this equipment in the original data source. To simplify communication with the operator,
						it’s a good idea to use the operator facility management system ID here.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="originalplaceinfoid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> original<wbr>Place<wbr>Info<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">original<wbr>Place<wbr>Info<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L282">EquipmentProperties.ts:282</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>ID of the place that this equipment belongs to (unique in the original data source)</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="outoforderreason" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> out<wbr>OfOrder<wbr>Reason</h3>
				<div class="tsd-signature tsd-kind-icon">out<wbr>OfOrder<wbr>Reason<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L205">EquipmentProperties.ts:205</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
					...
					<dl class="tsd-comment-tags">
						<dt>example</dt>
						<dd><p>‘Construction work’, ‘Vandalism’, ’Because of renovations the elevator on the west side is expected to be unavailable until April 1’</p>
						</dd>
					</dl>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="placeinfoid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> place<wbr>Info<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">place<wbr>Info<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L270">EquipmentProperties.ts:270</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Place info ID that this equipment belongs to (accessibility.cloud ID)</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="placesourceid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> place<wbr>Source<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">place<wbr>Source<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L276">EquipmentProperties.ts:276</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>ID of the place data source that this equipment belongs to (accessibility.cloud ID)</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="plannedcompletiondate" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> planned<wbr>Completion<wbr>Date</h3>
				<div class="tsd-signature tsd-kind-icon">planned<wbr>Completion<wbr>Date<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Date</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L250">EquipmentProperties.ts:250</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="servicephonenumber" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> service<wbr>Phone<wbr>Number</h3>
				<div class="tsd-signature tsd-kind-icon">service<wbr>Phone<wbr>Number<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L177">EquipmentProperties.ts:177</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Phone number where a service operator can be reached for help using this facility.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="servicewebsiteurl" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> service<wbr>Website<wbr>Url</h3>
				<div class="tsd-signature tsd-kind-icon">service<wbr>Website<wbr>Url<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L182">EquipmentProperties.ts:182</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>URL pointing to a website that describes the equipnent or it&#39;s current operational status.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">short<wbr>Description<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L80">EquipmentProperties.ts:80</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Contains the same information as description, but in a shorter form, to save space on the
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> source<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">source<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L255">EquipmentProperties.ts:255</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Data source ID on accessibility.cloud</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="sourceimportid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> source<wbr>Import<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">source<wbr>Import<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L260">EquipmentProperties.ts:260</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Data import ID on accessibility.cloud</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="stateexplanation" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> state<wbr>Explanation</h3>
				<div class="tsd-signature tsd-kind-icon">state<wbr>Explanation<span class="tsd-signature-symbol">:</span> <a href="../globals.html#localizedstring" class="tsd-signature-type">LocalizedString</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L233">EquipmentProperties.ts:233</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
					...
					<p>The text MUST NOT have abbreviations to be readable aloud by a screen reader or voice
					assistant.</p>
					<p>This field SHOULD only be used if a separation into individual disorder attributes
						(<code>state</code>, <code>outOfOrderReason</code>) is not technically possible (e.g. when existing APIs can not
					be further developed and users are only given one text field to describe the problem.)</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="statelastupdate" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> state<wbr>Last<wbr>Update</h3>
				<div class="tsd-signature tsd-kind-icon">state<wbr>Last<wbr>Update<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Date</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/EquipmentProperties.ts#L240">EquipmentProperties.ts:240</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
