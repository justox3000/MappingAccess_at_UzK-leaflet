...
<head>
	...
	<title>Staff | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="staff.html" class="tsd-kind-icon">Staff</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="staff.html#canseevisitorsfrominside" class="tsd-kind-icon">can<wbr>See<wbr>Visitors<wbr>From<wbr>Inside</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="staff.html#hasfreeassistantforvisitors" class="tsd-kind-icon">has<wbr>Free<wbr>Assistant<wbr>For<wbr>Visitors</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="staff.html#spokenlanguages" class="tsd-kind-icon">spoken<wbr>Languages</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="staff.html#canseevisitorsfrominside" class="tsd-kind-icon">can<wbr>See<wbr>Visitors<wbr>From<wbr>Inside</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="staff.html#hasfreeassistantforvisitors" class="tsd-kind-icon">has<wbr>Free<wbr>Assistant<wbr>For<wbr>Visitors</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="staff.html#spokenlanguages" class="tsd-kind-icon">spoken<wbr>Languages</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="canseevisitorsfrominside" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> can<wbr>See<wbr>Visitors<wbr>From<wbr>Inside</h3>
				<div class="tsd-signature tsd-kind-icon">can<wbr>See<wbr>Visitors<wbr>From<wbr>Inside<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Staff.ts#L18">Staff.ts:18</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if the staff has means to see visitors from the inside at all times when the place is
						open (for example a window or CCTV system), <code>false</code> if not, <code>undefined</code> if unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="hasfreeassistantforvisitors" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> has<wbr>Free<wbr>Assistant<wbr>For<wbr>Visitors</h3>
				<div class="tsd-signature tsd-kind-icon">has<wbr>Free<wbr>Assistant<wbr>For<wbr>Visitors<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Staff.ts#L28">Staff.ts:28</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>true</code> if there is an assistant for the duration of the visit that is free of charge, <code>false</code>
						if not, <code>undefined</code> if unknown.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="spokenlanguages" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> spoken<wbr>Languages</h3>
				<div class="tsd-signature tsd-kind-icon">spoken<wbr>Languages<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ArrayLike</span><span class="tsd-signature-symbol">&lt;</span><a href="../globals.html#ietflanguagetagorsignlanguagecode" class="tsd-signature-type">IetfLanguageTagOrSignLanguageCode</a><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Staff.ts#L22">Staff.ts:22</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Languages that the staff speaks, including sign language variants.</p>
					</div>
				</div>
			</section>
		</section>
