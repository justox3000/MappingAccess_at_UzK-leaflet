...
<head>
	...
	<title>Pathways | @sozialhelden/ac-format</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="pathways.html" class="tsd-kind-icon">Pathways</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="pathways.html#maxlateralslope" class="tsd-kind-icon">max<wbr>Lateral<wbr>Slope</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="pathways.html#maxlongitudinalslope" class="tsd-kind-icon">max<wbr>Longitudinal<wbr>Slope</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="pathways.html#width" class="tsd-kind-icon">width</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="pathways.html#widthatobstacles" class="tsd-kind-icon">width<wbr>AtObstacles</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Describes pathways inside a place.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">Pathways</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="pathways.html#maxlateralslope" class="tsd-kind-icon">max<wbr>Lateral<wbr>Slope</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="pathways.html#maxlongitudinalslope" class="tsd-kind-icon">max<wbr>Longitudinal<wbr>Slope</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="pathways.html#width" class="tsd-kind-icon">width</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="pathways.html#widthatobstacles" class="tsd-kind-icon">width<wbr>AtObstacles</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="maxlateralslope" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> max<wbr>Lateral<wbr>Slope</h3>
				<div class="tsd-signature tsd-kind-icon">max<wbr>Lateral<wbr>Slope<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Pathways.ts#L30">Pathways.ts:30</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Maximal lateral slope, in percent as calculated by <code>100 * rise / run</code> or the tangent of the angle of inclination, multiplied by 100</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="maxlongitudinalslope" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> max<wbr>Longitudinal<wbr>Slope</h3>
				<div class="tsd-signature tsd-kind-icon">max<wbr>Longitudinal<wbr>Slope<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Pathways.ts#L25">Pathways.ts:25</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Maximal longitudinal slope, in percent as calculated by <code>100 * rise / run</code> or the tangent of the angle of inclination, multiplied by 100</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Pathways.ts#L15">Pathways.ts:15</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Width constraints of all pathways inside a place relevant for consumers.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="widthatobstacles" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> width<wbr>AtObstacles</h3>
				<div class="tsd-signature tsd-kind-icon">width<wbr>AtObstacles<span class="tsd-signature-symbol">:</span> <a href="../globals.html#length" class="tsd-signature-type">Length</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/sozialhelden/ac-format/blob/0e0d5da/src/Pathways.ts#L20">Pathways.ts:20</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
